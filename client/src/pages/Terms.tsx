            ...
            {[
              {
                ...
                body: `LiteralVoice is a free, AI-powered tool that explains figurative language, idioms, sarcasm, and slang in plain, literal terms. It is provided as-is for informational and accessibility purposes.`,
              },
              {
              ...
              },
              {
                ...
                body: `The LiteralVoice application, design, and codebase are the property of the developers. AI-generated translation outputs are produced by Anthropic's Claude model; ownership of AI outputs is subject to Anthropic's terms of service.`,
              },
              {
                heading: "5. Limitation of liability",
                body: `To the fullest extent permitted by law, LiteralVoice and its developers shall not be liable for any indirect, incidental, or consequential damages arising from your use of the service.`,
              },
              {
              ...
              },
              {
                ...
                body: `These terms are governed by the laws of the jurisdiction in which the developer operates. Any disputes shall be resolved in that jurisdiction.`,
              },
            ].map(({ heading, body }) => (
